      ...
      <div className="max-w-lg mx-auto space-y-2">
        {siteConfig.quickLinks.items.map((link, index) => (
          <a
            ...
            className="quick-link flex items-center justify-between p-3 rounded-xl bg-card border border-border hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 group"
          >
